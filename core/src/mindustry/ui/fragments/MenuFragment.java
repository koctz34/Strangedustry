...
public class MenuFragment{
    ...
    private void buildMobile(){
        ...
        MobileButton
            ...
            gang = new MobileButton(Icon.move, "Game over for you.", ui.restart::show);
    ...
    private void buildDesktop(){
        ...
        float width = 230f;
        Drawable background = Styles.black5;
        ...
        container.table(background, t -> {
            ...
            buttons(t,
                new MenuButton("@play", Icon.play,
                    new MenuButton("@customgame", Icon.exit, () -> Core.app.exit())
                ),
                ...
                new MenuButton("Over for you...", Icon.move, ui.restart::show),
                    new MenuButton("Over for you...", Icon.planet, ui.planet::show),
                    new MenuButton("Over for you...", Icon.move, ui.restart::show),
                    new MenuButton("Over for you...", Icon.move, ui.restart::show),
                    new MenuButton("[#ff]Over for you...", Icon.move, ui.effects::show),
                    new MenuButton("[#00ff]Over for you...", Icon.move, ui.join::show),
                    new MenuButton("Over for you...", Icon.move, ui.restart::show),
                    new MenuButton("Over for you...", Icon.move, ui.restart::show),
                    new MenuButton("[#ff]Over for you...", Icon.terrain, ui.custom::show)
            );
