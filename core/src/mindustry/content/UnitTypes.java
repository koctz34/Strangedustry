    ...
    public static void load(){
        ...
        mace = new UnitType("mace"){{
            ...
            weapons.add(new Weapon("flamethrower"){{
                ...
                recoil = 1f;
                ejectEffect = Fx.none;
                bullet = new BulletType(4.2f, 50f){{
                    ammoMultiplier = 3f;
                    hitSize = 20f;
                    lifetime = 14f;
                    pierce = true;
        ...
        fortress = new UnitType("fortress"){{
            ...
            weapons.add(new Weapon("artillery"){{
                ...
                bullet = new ArtilleryBulletType(30f, 20, "laser"){{
        ...
        scepter = new UnitType("scepter"){{
            ...
            abilities.add(new UnitSpawnAbility(UnitTypes.dagger, 60f * 5, 0, -2));
        }};
        ...
        reign = new UnitType("reign"){{
            ...
            new Weapon("reign-weapon"){{
                ...
                bullet = new BasicBulletType(30f, 50){{
                    pierce = true;
                    pierceCap = 10;
                    width = 14f;
                    height = 33f;
        ...
        nova = new UnitType("nova"){{
            ...
            abilities.add(new RepairFieldAbility(999f, 60f * 1, 120f));
        ...
        quasar = new UnitType("quasar"){{
            ...
            weapons.add(new Weapon("beam-weapon"){{
                ...
                bullet = new LaserBulletType(){{
                    ...
                    collidesTeam = true;
                    length = 200f;
                    colors = new Color[]{Pal.neoplasmMid.cpy().a(0.4f), Pal.neoplasm2, Color.white};
                }};
            }});
        }};
        ...
        corvus = new UnitType("corvus"){{
            ...
            weapons.add(new Weapon("corvus-weapon"){{
                ...
                bullet = new LaserBulletType(){{
                    ...
                    lightningSpacing = 1488f;
                    lightningLength = 700;
                    lightningDelay = 7f;
                    lightningLengthRand = 20;
                    lightningDamage = 993939;
                    lightningAngleRand = 60f;
                    largeHit = true;
        ...
        flare = new UnitType("flare"){{
            ...
            weapons.add(new Weapon(){{
                ...
                ejectEffect = Fx.casing1;
                bullet = new BasicBulletType(6f, 99999){{
                    width = 50f;
                    height = 50f;
                    lifetime = 70f;
                    shootEffect = Fx.shootSmall;
        ...
        horizon = new UnitType("horizon"){{
            ...
            weapons.add(new Weapon(){{
                ...
                bullet = new BombBulletType(800f, 80f){{
                    width = 10f;
                    height = 14f;
        ...
        oct = new UnitType("oct"){{
            ...
            faceTarget = false;
            hitSize = 66f;
            payloadCapacity = (100f * 5.5f) * tilePayload;
            buildSpeed = 4f;
            drawShields = false;
            lowAltitude = true;
            buildBeamOffset = 43;
        ...
        bryde = new UnitType("bryde"){{
            ...
            abilities.add(new SpawnDeathAbility(UnitTypes.flare, 40, 5f));
