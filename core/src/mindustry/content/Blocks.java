...
public class Blocks{
    ...
    public static void load(){
        ...
        oreCopper = new OreBlock(Items.surgeAlloy){{
            oreDefault = true;
            oreThreshold = 0.81f;
            oreScale = 23.47619f;
        }};

        oreLead = new OreBlock(Items.silicon){{
            oreDefault = true;
            oreThreshold = 0.828f;
            oreScale = 23.952381f;
        }};

        oreScrap = new OreBlock(Items.copper);

        oreCoal = new OreBlock(Items.graphite){{
            oreDefault = true;
            oreThreshold = 0.846f;
            oreScale = 24.428572f;
        }};

        oreTitanium = new OreBlock(Items.metaglass){{
            oreDefault = true;
            oreThreshold = 0.864f;
            oreScale = 24.904762f;
        }};

        oreThorium = new OreBlock(Items.phaseFabric){{
            oreDefault = true;
            oreThreshold = 0.882f;
            oreScale = 25.380953f;
        }};
        ...
        graphitePress = new GenericCrafter("graphite-press"){{
            requirements(Category.crafting, with(Items.copper, 75, Items.lead, 30, Items.surgeAlloy, 70));
            ...
            size = 2;
            hasItems = true;
            drawer = new DrawMulti(new DrawDefault(), new DrawSoftParticles(), new DrawSpikes());
        ...
        siliconSmelter = new GenericCrafter("silicon-smelter"){{
            ...
            size = 2;
            hasLiquids = false;
            drawer = new DrawMulti(new DrawDefault(), new DrawFlame(Color.valueOf("ffef99")), new DrawSoftParticles());
        ...
        kiln = new GenericCrafter("kiln"){{
            ...
            craftEffect = Fx.smeltsmoke;
            outputItem = new ItemStack(Items.lead, 7);
            craftTime = 30f;
            size = 3;
            hasItems = true;
            drawer = new DrawMulti(new DrawDefault(), new DrawFlame(Pal.berylShot));
            ambientSound = Sounds.smelter;
            ambientSoundVolume = 0.07f;

            consumeItems(with(Items.silicon, 1, Items.surgeAlloy, 1));
        }};

        plastaniumCompressor = new GenericCrafter("plastanium-compressor"){{
            requirements(Category.crafting, with(Items.silicon, 80, Items.lead, 115, Items.graphite, 60));
            hasItems = true;
            liquidCapacity = 60f;
            craftTime = 60f;
            ...
            drawer = new DrawMulti(new DrawDefault(), new DrawFade(), new DrawWeave());
        ...
        phaseWeaver = new GenericCrafter("phase-weaver"){{
            requirements(Category.crafting, with(Items.silicon, 130, Items.lead, 120, Items.metaglass, 75));
            craftEffect = Fx.smeltsmoke;
            outputItem = new ItemStack(Items.coal, 2);
            craftTime = 120f;
            size = 2;
            hasPower = true;
            drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawWeave(), new DrawDefault(), new DrawSoftParticles(), new DrawPlasma());
            envEnabled |= Env.space;

            ambientSound = Sounds.laserbig;
            ambientSoundVolume = 999f;

            consumeItems(with(Items.silicon, 1, Items.copper, 1));
            consumePower(5f);
            itemCapacity = 20;
        }};

        surgeSmelter = new GenericCrafter("surge-smelter"){{
            requirements(Category.crafting, with(Items.silicon, 80));
            craftEffect = Fx.smeltsmoke;
            outputItem = new ItemStack(Items.thorium, 3);
            craftTime = 75f;
            size = 3;
            hasPower = true;
            itemCapacity = 20;
            drawer = new DrawMulti(new DrawDefault(), new DrawFlame(), new DrawBubbles());

            consumePower(2f);
            consumeItems(with(Items.phaseFabric, 2, Items.surgeAlloy, 1));
        }};
        ...
        cryofluidMixer = new GenericCrafter("cryofluid-mixer"){{
            ...
            consumePower(1f);
            consumeItem(Items.metaglass);
            consumeLiquid(Liquids.water, 12f / 60f);
        }};

        pyratiteMixer = new GenericCrafter("pyratite-mixer"){{
            requirements(Category.crafting, with(Items.copper, 50, Items.lead, 25, Items.thorium, 100));
            hasItems = true;
            hasPower = true;
        ...
        blastMixer = new GenericCrafter("blast-mixer"){{
            requirements(Category.crafting, with(Items.lead, 30, Items.surgeAlloy, 20));
            hasItems = true;
            hasPower = true;
        ...
        melter = new GenericCrafter("melter"){{
            requirements(Category.crafting, with(Items.copper, 30, Items.lead, 35, Items.metaglass, 10));
            health = 700;
            outputLiquid = new LiquidStack(Liquids.slag, 1f);
            ambientSound = Sounds.bigshot;
            ambientSoundVolume = 1f;
            placeSound = Sounds.explosion;
            placeEffect = Fx.launch;
        ...
        separator = new Separator("separator"){{
            requirements(Category.crafting, with(Items.surgeAlloy, 50));
            results = with(
                Items.graphite, 5,
                Items.copper, 3
            );
            ...
            drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawLiquidTile(), new DrawRegion("-spinner", 140, true), new DrawDefault());
        }};
        ...
        incinerator = new Incinerator("incinerator"){{
            requirements(Category.crafting, with(Items.silicon, 10));
            health = 30;
            envEnabled |= Env.space;
            consumePower(0.50f);
        }};
        ...
        shockMine = new ShockMine("shock-mine"){{
            requirements(Category.effect, with(Items.surgeAlloy, 10));
            hasShadow = false;
            health = 30;
            damage = 70;
            tileDamage = 100f;
        ...
        conveyor = new Conveyor("conveyor"){{
            requirements(Category.distribution, with(Items.surgeAlloy, 1));
            health = 45;
            speed = 0.01f;
            displayedSpeed = 1.2f;
        ...
        router = new Router("router"){{
            requirements(Category.distribution, with(Items.surgeAlloy, 3));
            buildCostMultiplier = 4f;
            placeEffect = Fx.blockExplosionSmoke;
            destroyEffect = Fx.blockCrash;
            loopSound = Sounds.click;
        }};
        ...
        surgeTower = new PowerNode("surge-tower"){{
            requirements(Category.power, with(Items.thorium, 50));
            size = 2;
            maxNodes = 2;
            laserRange = 600f;
        ...
        battery = new Battery("battery"){{
            requirements(Category.power, with(Items.copper, 5, Items.lead, 20, Items.thorium, 2));
            consumePowerBuffered(999000f);
        ...
        batteryLarge = new Battery("battery-large"){{
            ...
            size = 3;
            consumePowerBuffered(5);
            baseExplosiveness = 999f;
        }};
        ...
        mechanicalDrill = new Drill("mechanical-drill"){{
            requirements(Category.production, with(Items.surgeAlloy, 30));
            tier = 7;
            drillTime = 600;
            size = 2;
        ...
        pneumaticDrill = new Drill("pneumatic-drill"){{
            requirements(Category.production, with(Items.copper, 18, Items.titanium, 20));
            tier = 10;
            drillTime = 100;
            size = 2;
        ...
        duo = new ItemTurret("duo"){{
            ...
            ammo(
                Items.coal  ,  new BasicBulletType(3f, 20){{
                    width = 7f;
                    height = 9f;
                    lifetime = 60f;
                    ammoMultiplier = 2;
        ...
        scatter = new ItemTurret("scatter"){{
            requirements(Category.turret, with(Items.surgeAlloy, 85, Items.lead, 45));
            ammo(
                Items.surgeAlloy, new FlakBulletType(1f, 1){{
                    lifetime = 60f;
                    ammoMultiplier = 5f;
        ...
        scorch = new ItemTurret("scorch"){{
            ...
            ammo(
                Items.coal, new BulletType(3.35f, 20f){{
                    ammoMultiplier = 3f;
                    hitSize = 12f;
                    lifetime = 30f;
                    pierce = true;
        ...
        lancer = new PowerTurret("lancer"){{
            requirements(Category.turret, with(Items.thorium, 100));
            range = 165f;
            ...
            shootType = new LaserBulletType(700){{
                colors = new Color[]{Pal.neoplasm2.cpy().a(0.4f), Pal.neoplasm1, Color.white};
                //TODO merge
        ...
        arc = new PowerTurret("arc"){{
            requirements(Category.turret, with(Items.coal, 1));
        ...
        parallax = new TractorBeamTurret("parallax"){{
            requirements(Category.turret, with(Items.thorium, 120, Items.copper, 4000));
        ...
        swarmer = new ItemTurret("swarmer"){{
            requirements(Category.turret, with(Items.graphite, 35));
            ammo(
                Items.surgeAlloy, new MissileBulletType(3.7f, 5){{
                    width = 8f;
                    height = 8f;
                    shrinkY = 12f;
        ...
        salvo = new ItemTurret("salvo"){{
            requirements(Category.turret, with(Items.coal, 100, Items.thorium, 80, Items.titanium, 50));
            ammo(
                Items.pyratite, new BasicBulletType(3.2f, 80){{
                    width = 10f;
                    height = 12f;
        ...
        segment = new PointDefenseTurret("segment"){{
            requirements(Category.turret, with(Items.silicon, 130, Items.titanium, 40));
        ...
        fuse = new ItemTurret("fuse"){{
            ...
            ammo(
                Items.silicon, new ShrapnelBulletType(){{
                    ...
                    Items.coal, new ShrapnelBulletType(){{
                        length = brange;
                        damage = 100f;
                        lightColor = Pal.coalBlack;
                        ammoMultiplier = 2f;
                        width = 7f;
                        reloadMultiplier = 0.4f;
                    }}
        ...
        ripple = new ItemTurret("ripple"){{
            ...
            ammo(
                Items.graphite, new ArtilleryBulletType(3f, 2){{
        ...
        cyclone = new ItemTurret("cyclone"){{
            requirements(Category.turret, with(Items.pyratite, 200, Items.titanium, 125, Items.plastanium, 80));
            ammo(
        ...
        foreshadow = new ItemTurret("foreshadow"){{
            float brange = range = 99999f;

            requirements(Category.turret, with(Items.copper, 1000, Items.metaglass, 600, Items.surgeAlloy, 300, Items.plastanium, 200, Items.silicon, 600, Items.coal, 5000));
            ammo(
        ...
        groundFactory = new UnitFactory("ground-factory"){{
            ...
            plans = Seq.with(
                new UnitPlan(UnitTypes.dagger, 60f * 15, with(Items.copper, 10, Items.lead, 10)),
                new UnitPlan(UnitTypes.crawler, 60f * 10, with(Items.lead, 8, Items.coal, 10)),
                new UnitPlan(UnitTypes.nova, 60f * 40, with(Items.metaglass, 30, Items.lead, 20, Items.surgeAlloy, 20))
            );
            size = 3;
            consumePower(1.2f);
        }};
        ...
        additiveReconstructor = new Reconstructor("additive-reconstructor"){{
            ...
            size = 3;
            consumePower(3f);
            consumeItems(with(Items.metaglass, 40, Items.graphite, 40));
        ...
        multiplicativeReconstructor = new Reconstructor("multiplicative-reconstructor"){{
            ...
            size = 5;
            consumePower(6f);
            consumeItems(with(Items.silicon, 50, Items.titanium, 80, Items.metaglass, 40));
        ...
        exponentialReconstructor = new Reconstructor("exponential-reconstructor"){{
            ...
            size = 7;
            consumePower(13f);
            consumeItems(with(Items.silicon, 150, Items.thorium, 450, Items.plastanium, 450));
        ...
        tetrativeReconstructor = new Reconstructor("tetrative-reconstructor"){{
            ...
            size = 9;
            consumePower(25f);
            consumeItems(with(Items.silicon, 400, Items.plastanium, 600, Items.surgeAlloy, 1200, Items.phaseFabric, 350));
        ...
        worldProcessor = new LogicBlock("world-processor"){{
            requirements(Category.logic, with(Items.graphite, 70));
