...
public class TantrosPlanetGenerator extends PlanetGenerator{
    Color c1 = Pal.neoplasm1, c2 = Pal.neoplasm2, out = new Color();

    Block[][] arr = {
    {Blocks.grass, Blocks.water, Blocks.darksand, Blocks.grass, Blocks.stone, Blocks.dirt, Blocks.grass, Blocks.stone, Blocks.dirt, Blocks.grass},
    };
