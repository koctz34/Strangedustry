...
public class ErekirPlanetGenerator extends PlanetGenerator{
    public float heightScl = 0.9f, octaves = 7, persistence = 0.7f, heightPow = 3f, heightMult = 1.6f;

    //TODO inline/remove
    public static float arkThresh = 0.28f, arkScl = 0.83f;
    public static int arkSeed = 6, arkOct = 1;
    public static float liqThresh = 0.64f, liqScl = 87f, redThresh = 1.1f, noArkThresh = 0.3f;
    public static int crystalSeed = 7, crystalOct = 2;
    public static float crystalScl = 0.4f, crystalMag = 1f;
    public static float airThresh = 0.13f, airScl = 14;

    Block[] terrain = {Blocks.grass, Blocks.water, Blocks.water, Blocks.grass, Blocks.water, Blocks.grass, Blocks.grass, Blocks.carbonStone,
            Blocks.grass, Blocks.water, Blocks.water, Blocks.grass, Blocks.water, Blocks.grass, Blocks.grass, Blocks.carbonStone,
            Blocks.grass, Blocks.water, Blocks.water, Blocks.grass, Blocks.water, Blocks.grass, Blocks.grass, Blocks.carbonStone,
            Blocks.grass, Blocks.water, Blocks.water, Blocks.grass, Blocks.water, Blocks.grass, Blocks.grass, Blocks.carbonStone};
    ...
    Block getBlock(Vec3 position){
        ...
        if(ice < 0.6){
            if(result == Blocks.grass || result == Blocks.water){
