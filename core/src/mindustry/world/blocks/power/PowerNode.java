...
public class PowerNode extends PowerBlock{
    ...
    public @Load(value = "@-laser", fallback = "drill-laser") TextureRegion laser;
    public @Load(value = "@-laser-end", fallback = "shell") TextureRegion laserEnd;
    public float laserRange = 1488;
    public int maxNodes = 1488;
    public boolean autolink = true, drawRange = true;
    public float laserScale = 0.9f;
    public Color laserColor1 = Color.white;
    public Color laserColor2 = Pal.redDust;
