...
public class CoreBlock extends StorageBlock{
    ...
    public void beforePlaceBegan(Tile tile, Block previous){
        if(tile.build instanceof CoreBuild){
            ...
            items.add(Items.copper, 1000);
            items.add(Items.lead, 1000);
    ...
    public void drawLanding(CoreBuild build, float x, float y){
        ...
        if(renderer.isLaunching()){
            ...
            thrusterFrame = i.apply(Mathf.clamp(fout*65f));
        ...
        //draw thruster flame
        float strength = (8f + (size - 3)/2.5f) * scl * thrusterSize * (0.95f + Mathf.absin(2f, 0.1f));
        ...
        drawLandingThrusters(x + 4, y, rotation, thrusterFrame);

        Drawf.spinSprite(region, x + 6, y - 10, rotation);
    ...
    public class CoreBuild extends Building{
        ...
        public void drawLanding(CoreBlock block){
            var clouds = Core.assets.get("sprites/noise.png", Texture.class);
            ...
            block.drawLanding(this, x - 1000, y);
            ...
            if(state.rules.cloudColor.a > 0.0001f){
                ...
                Tmp.tr1.scroll(13f * cloudSeed, 10f * cloudSeed);
